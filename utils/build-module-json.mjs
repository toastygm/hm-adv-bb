...
template.url = "https://github.com/toastygm/hm-adv-bb";
template.bugs = "https://github.com/toastygm/hm-adv-bb/issues";
template.manifest =
    "https://github.com/toastygm/hm-adv-bb/releases/latest/download/module.json";
template.download = `https://github.com/toastygm/hm-adv-bb/releases/download/v${pkg.version}/module.zip`;
